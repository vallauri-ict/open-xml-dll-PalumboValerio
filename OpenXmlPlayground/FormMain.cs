        ...
        private void btnSimpleWordTest_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                using (WordprocessingDocument doc = WordprocessingDocument.Create(filepath, WordprocessingDocumentType.Document))
                {
                    ...
                    #region Style
                    // Define the styles
                    ClsOpenXmlUtilities.AddStyle(mainPart, false, true, true, "MyHeading1", "Titolone", "Verdana", 30, "0000FF");
                    ClsOpenXmlUtilities.AddStyle(mainPart, true, false, false, "MyTypescript", "Macchina da scrivere", "Courier New", 10, "333333");
                    ...
                    Table myTable = ClsOpenXmlUtilities.createTable(mainPart, bolds, italics, underlines, texts1, justifications, 2, 2, "CC0000");
                    body.Append(myTable);
                    #endregion
                    ...
                    ClsOpenXmlUtilities.CreateBulletOrNumberedList(100, 200, bulletList, texts2.Length, texts2);
                    foreach (Paragraph paragraph in bulletList)
                        body.Append(paragraph);

                    // Append numbered list
                    List<Paragraph> numberedList = new List<Paragraph>();
                    ClsOpenXmlUtilities.CreateBulletOrNumberedList(100, 240, numberedList, texts2.Length, texts2, false);
